'use client'
import { updateAttendance, updateAttendanceMock } from '@/actions/attendance'
...
export function AttendanceStatusSwitcher({ lessonId, studentId, status }: AttendanceStatusSwitcherProps) {
  ...
  return (
    ...
    >
      <Tooltip key={'absent'} delayDuration={500}>
        ...
        >
          <ToggleGroupItem value={AttendanceStatus.ABSENT} aria-label="absent" disabled={status === AttendanceStatus.ABSENT || isPending}>
      ...
      <Tooltip key={'present'} delayDuration={500}>
        ...
        >
          <ToggleGroupItem value={AttendanceStatus.PRESENT} aria-label="present" disabled={status === AttendanceStatus.PRESENT || isPending}>
